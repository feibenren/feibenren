...
`OO编程方式`的影响很大，甚至是高级的编程语言都将这当作了基础思想,比如JAVA,PHP等
...
-------------
虽然solid原则是基于OO的，但是其中有一些基本思想，也有人说solid是可以适用于所有的软件开发

-------------

OO是现在的`主流编程方式`，虽然好处很多，不需要知道那些先贤思想，直接使用即可，因为只要按照OOP写，就可以非常简单的`实现先贤的思想`
...
MVC体现的思想是更高维度考虑的问题(`专注点是架构`)，是大智慧

23种设计模式是底层的，基础的考虑问题(`专注点是代码`)，是小技巧
